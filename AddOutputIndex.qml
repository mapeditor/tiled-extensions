/* 	Add Output Index script by eishiya, last updated 15 Mar 2024
	...
	Requires Tiled 1.13+ (see the master branch for a version compatible
	with older Tiled versions)
	...
	You can uninstall it when you're done, in which case you can still run
